package com.askeruzmani.asker_uzmani_backend.Controllers.api;
...
public class Paths {
    ...
    public static final String ORDERS = ROOT_PATH + "/orders";
    public static final String PAYTR = ROOT_PATH + "/paytr";
}
